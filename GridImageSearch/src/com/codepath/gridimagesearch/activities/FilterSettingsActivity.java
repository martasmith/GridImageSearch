...
public class FilterSettingsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		aSprImageSize = ArrayAdapter.createFromResource(this, R.array.imageSizeArr, R.layout.item_custom_textview);
		aSprColorFilter = ArrayAdapter.createFromResource(this, R.array.colorFilterArr, R.layout.item_custom_textview);
		aSprImageType = ArrayAdapter.createFromResource(this, R.array.imageTypeArr, R.layout.item_custom_textview);
        ...
        if (extras != null) {
        	...
        	if (extras.containsKey("colorFilterValue") && (extras.getString("colorFiterValue") != "")) {
        	...
        	if (extras.containsKey("siteFilterValue") && (extras.getString("siteFilterValue") != "")) {
